...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
	        ...
	        dialog.setTitle("PremiÃ¨re connexion");
	        dialog.setMessage("C'est la premiÃ¨re fois que vous utilisez Kiveukoi.\n" +
	        		"Veuillez renseigner votre adresse email et votre mot de passe, puis choissiez un code Ã  4 chiffres.");
	        dialog.setIcon(android.R.drawable.ic_dialog_alert);
	        dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface arg0, int arg1) {
					/**
					 * Si on n'a pas de base de donnÃ©es,
					 * on redirige vers la premiÃ¨re connexion
					 * pour dÃ©finir un code PIN
					 */
		...
		/**
		 * Passer d'une case Ã  la suivante Quand le premier est rempli, on passe
		...
		/**
		 * Quand le deuxiÃ¨me est rempli, on passe au troisiÃ¨me Si on supprime,
		 * on retourne Ã  la case d'avant
		 */
		...
		/**
		 * Quand la troisiÃ¨me est rempli, on passe au dernier Quand la troisiÃ¨me
		 * est remplie, on passe au dernier Si on supprime, on retourne Ã  la
		 * case d'avant
		 */
		...
		/**
		 * Si on supprime, on retourne Ã  la case d'avant
		 */
	...
	public void onClick(View v) {
		...
		/**
		 * VÃ©rification du code PIN saisi
		 */
		 ...
		 * 
		 * @TODO si tous les champs sont remplis, on compare le code donnÃ© avec
		 *       celui dans la base et on renvoie true => on va Ã  l'accueil
		 */
